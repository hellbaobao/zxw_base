...
<html lang="zh-CN">
    <head>
        ...
        <script type="text/javascript" src="/Public/admin/js/Zxw/info.js"></script>
    </head>
    <body>
        <div class="option_search">
            <form method="get" action="/index.php/Admin/ZxwInfo/showList" class="form-horizontal" id="search-form" style="margin-top: 20px;">
                <div class="form-group">
                    <div class="col-sm-3" style="min-width: 200px;">
                        <button type="button" class="btn btn-success addZxwInfo" id="addInfo-btn" onclick="javascript:void(window.location.href = '/index.php/Admin/ZxwInfo/add')" style="height: 34px;">
                            <span class="glyphicon glyphicon-plus"></span> 新增
                        </button>
                        <button type="button" class="btn btn-danger delZxwInfo" id="delArrayInfo-btn" style="height: 34px;">
        ...
        <div class="table_content">
            <table class="table table-hover">
                ...
                <?php if(!empty($infoList)): if(is_array($infoList)): foreach($infoList as $k=>$v): ?><tr class="tr">
                        ...
                        <a href="/index.php/Admin/ZxwInfo/detail/id/<?php echo ($v["id"]); ?>"><?php echo ($v["title"]); ?></a>
                        ...
                        <td>
                            <div>
                                <button class="btn btn-default edit-btn editZxwInfo" onclick="javascript:void(window.location.href = '/index.php/Admin/ZxwInfo/edit/id/<?php echo ($v["id"]); ?>')">
                                    <span class="glyphicon glyphicon-edit"></span> 编辑
                                </button>
                                <button class="btn btn-default pubZxwInfo" onclick="pubInfoLayer(<?php echo ($v["id"]); ?>)">
            ...
            <?php if(empty($infoList)): ?><div style="text-align: center;">暂无数据</div><?php endif; ?>
            <noempty name="infoList">
